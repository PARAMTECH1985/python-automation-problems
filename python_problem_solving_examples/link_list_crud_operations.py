...
8.Update the Node based on Index
9.Print the all the Nodes
...
llist.insertAtEnd('e')
llist.insertAtEnd('f')
print("Print All the Nodes Before Remove")
llist.printLL()
print("----------------------------------")
llist.remove_node('f')
print("Print All the Nodes After Remove")
llist.printLL()
print("----------------------------------")
llist.remove_at_index(2)
print("Print All the Nodes After Removing Index 2")
llist.printLL()
print("----------------------------------")
llist.updateNode('t', 2)
print("Print All the Nodes After Removing Index 2")
llist.printLL()
print("----------------------------------")
